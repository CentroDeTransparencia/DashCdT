...
@callback(Output('info_proyecto','children'),
...
#@callback(Output('diversidad_fauna', 'figure'), Input('selector_epoca_diversidad', 'value'))
...
#    return 
@callback(Output('tabs-contentgraph_kale_f', 'children'), Input('tabsgraph_f_kale', 'value'))
...
@callback(Output('tabs-contentgraph_kale_v', 'children'), Input('tabsgraph_v_kale', 'value'))
...
@callback(Output('tabs-contentgraph_kale_h', 'children'), Input('tabsgraph_h_kale', 'value'))
...
@callback(Output('tabs-contentgraph_kale_m', 'children'), Input('tabsgraph_m_kale', 'value'))
...
@callback(Output('tabs-contentgraph_platero_f', 'children'), Input('tabsgraph_f_platero', 'value'))
...
@callback(Output('tabs-contentgraph_platero_v', 'children'), Input('tabsgraph_v_platero', 'value'))
...
@callback(Output('tabs-contentgraph_platero_h', 'children'), Input('tabsgraph_h_platero', 'value'))
...
@callback(Output('tabs-contentgraph_platero_m', 'children'), Input('tabsgraph_m_platero', 'value'))
